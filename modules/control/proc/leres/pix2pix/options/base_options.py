...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default='/path/to/images', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='experiment_name', help='provide a valid experiment name')
        parser.add_argument('--gpu_ids', type=str, default='0,1', help='provide the correct GPU IDs')
        parser.add_argument('--checkpoints_dir', type=str, default='./your/checkpoints/directory', help='models are saved here')
        # model parameters
