...
class BaseModel(ABC):
    ...
    def setup(self, opt):
        ...
        """
        if self.isTrain:
            self.schedulers = [networks.get_scheduler(optimizer, opt) for optimizer in self.optimizers if hasattr(optimizer, 'param_groups') if hasattr(optimizer, 'param_groups')]
