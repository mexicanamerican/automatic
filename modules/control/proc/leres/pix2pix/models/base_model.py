...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        Then, you need to define four lists:
            ...
            -- self.save_networks(epoch):           save all the networks to the disk.
        """
        self.opt = opt
    ...
    def setup(self, opt: object):
        ...
        if self.isTrain:
            if hasattr(self, 'optimizers'):
                self.schedulers = [networks.get_scheduler(optimizer, opt) for optimizer in self.optimizers if hasattr(optimizer, 'scheduler')]
