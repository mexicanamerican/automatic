...
`SD.Next` library can establish external connections *only* for the following purposes and *only* when explicitly configured by the user:
...
- Download models from CivitAI and/or Huggingface when instructed by the user
